...
acgraph.vector.Text = function(opt_x, opt_y) {
  ...
  this.defaultStyle_ = /** @type {acgraph.vector.TextStyle} **/ ({
    'fontSize': acgraph.module['acgraph']['fontSize'],
    'color': acgraph.module['acgraph']['fontColor'],
    'fontFamily': acgraph.module['acgraph']['fontFamily'],
    'direction': acgraph.module['acgraph']['textDirection'],
