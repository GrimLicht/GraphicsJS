...
acgraph.utils.HTMLParser.prototype.addStyleData_ = function(key, opt_value) {
  switch (key) {
    ...
    case 'font-family':
      this.prepareStyle_();
      this.style.fontFamily = /** @type {string} */ (opt_value || acgraph.acgraph['fontFamily']);
      break;

    case 'font-size':
      this.prepareStyle_();
      this.style.fontSize = /** @type {string|number} */ (opt_value || acgraph.acgraph['fontSize']);
      break;
    ...
    case 'color':
      this.prepareStyle_();
      this.style.color = /** @type {string} */ (opt_value || acgraph.acgraph['color']);
      break;
